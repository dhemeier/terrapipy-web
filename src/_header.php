...
<html>
    <head>
        ...
        <link rel="stylesheet"
              href="adminlte/dist/css/skins/skin-<?php echo(isset($pageSkin) ? $pageSkin : "blue") ?>.min.css">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> <span>Start</span></a>
                        </li>
                    </ul>
                    <ul class="sidebar-menu">
                        <li class="header">Terrarien</li>
                        <?php
                        $terrariumPages = getPages($pimaticUsername, $pimaticPassword, $pimaticHost,
                                                   $pimaticTerrariumKeyword);
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="emergencyshutdown.php"><i class="fa fa-exclamation-circle text-red"></i> <span
                                        class="text-red">NOTAUS</span></a></li>
                    </ul>
                    <!-- /.sidebar-menu -->
                </section>
                <!-- /.sidebar -->
